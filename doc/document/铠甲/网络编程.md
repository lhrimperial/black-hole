...
TCP/IP https://www.jianshu.com/p/4ba0d706ee7c

https://www.jianshu.com/p/0947b7b3c3c1

https://www.huaweicloud.com/articles/7610c276e99a87e7df87b4acb43cc605.html

##### 一、Socket

1. socket概念

   Socket 这个概念没有对应到一个具体的实体，它是描述计算机之间完成相互通信一种抽象功能，socket是在应用层和传输层之间的一个抽象层，它把TCP/IP层复杂的操![A8E4C366-E136-4660-8069-C91DA376AE37](网络编程.assets/A8E4C366-E136-4660-8069-C91DA376AE37.png)作抽象为几个简单的接口供应用层调用，它是一组接口。



下图是典型的基于 Socket 的通信的场景：

![image017](网络编程.assets/image017.jpg)
...
2. 建立通信链路
   ...
   ![1652f12fa745cb4f](网络编程.assets/1652f12fa745cb4f-3500998.png)
...
![nio-buffer](网络编程.assets/nio-buffer.png)
...
![nio-channel](网络编程.assets/nio-channel.png)
...
我们需要将创建的一个或多个可选择的`Channel`注册到`Selector`对象中，一个键(`SelectionKey`)将会被返回。SelectionKey 会记住您关心的通道。它们也会追踪对应的通道是否已经就绪。

![1483540103154037014](网络编程.assets/1483540103154037014.png)
...
![1486130747296085576](网络编程.assets/1486130747296085576-3501329.png)
...
1. ##### Channel
   ...
   **Netty中TCP编程的Channel类图继承关系如下：**
   ...
   ![netty-channel](网络编程.assets/netty-channel-3501361.png)
...
2. #####ChannelConfig
   ...
   ![netty-channel-config](网络编程.assets/netty-channel-config-3501411.png)
...
4. **ChannelHander**
   ...
   ![netty-channelHandler](网络编程.assets/netty-channelHandler.png)
...
6. **ChannelHandlerContext**
   ...
   ![ChannelHandlerContext](网络编程.assets/ChannelHandlerContext.png)
...
7. ##### ChannelHander、ChannelPipeline、ChannelHandlerContext的联合工作过程
   ...
   ![channelpipeline-ChannelHandlerContext](网络编程.assets/channelpipeline-ChannelHandlerContext.png)
