package com.github.black.hole.sboot.ding.encrypt;
...
public class DingTalkEncryptor {
    ...
    private static void RemoveCryptographyRestrictions() throws Exception {
        ...
        if (jceSecurity != null) {
            ...
            PermissionCollection defaultPolicy = getFieldValue(jceSecurity, "defaultPolicy", (Object)null, PermissionCollection.class);
